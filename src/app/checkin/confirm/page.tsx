...
// WhatsApp group for the Day 2 afternoon session (below-30K segment).
const WHATSAPP_GROUP_URL = 'https://chat.whatsapp.com/BnSVzkrAdABBjH8XfQbI0M?s=cl&p=a&mlu=3&amv=2'
